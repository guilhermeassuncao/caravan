            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="px-5 pb-5 pt-3">
                        ...
                        <small class="form-text text-muted text-center mb-4">Esqueceu a senha? <a href="#">Clique
                                aqui</a></small>
                    </form>
                </div>
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle font-weight-bold text-dark <?php if ($urlAtual == '/locais')
                        echo " active"; ?>" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                ...
                <li class="nav-item">
                    <a class="nav-link font-weight-bold text-dark ml-md-3 <?php if ($urlAtual == '/planos')
                        echo " active"; ?>" href="/planos">Planos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bold text-dark ml-md-3 <?php if ($urlAtual == '/contato')
                        echo " active"; ?>" href="/contato">Contato</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bold text-dark ml-md-3" href="#" data-toggle="modal"
                        data-target="#modalLogin">Login</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-outline-primary ml-md-3 my-2 my-md-0 font-weight-bold"
                        href="/inscricao">Inscreva-se</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="container py-4">
            <div class="row mt-4">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 mb-3 mb-md-3">
                    ...
                    <ul class="list-unstyled mt-3">
                        <li class="mb-1">
                            <a class="btn btn-outline-secondary btn-sm btn-block mb-2" href="#"
